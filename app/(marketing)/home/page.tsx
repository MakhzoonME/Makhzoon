...
function PackageSVG() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
      <path d="M16.5 6.5l-6.5-4-6.5 4v7l6.5 4 6.5-4v-7z" stroke="currentColor" strokeWidth="1.4" fill="none" />
      <path d="M10 2.5v14M3.5 6.5l6.5 4 6.5-4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
function UsersSVG() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
      ...
      <path d="M2 16c0-3.314 2.686-5 6-5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
      <circle cx="14" cy="8" r="2.5" stroke="currentColor" strokeWidth="1.4" />
      <path d="M17.5 16c0-2.761-1.567-4-3.5-4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
function WrenchSVG() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
      <path d="M14.5 2.5a3.5 3.5 0 0 0-3.46 4.06L4 13.6A1.5 1.5 0 1 0 6.4 16l7.04-7.04A3.5 3.5 0 0 0 14.5 2.5z" stroke="currentColor" strokeWidth="1.4" fill="none" />
      <circle cx="5.5" cy="14.5" r="0.8" fill="currentColor" />
    </svg>
  );
}
function FileSVG() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
      <path d="M5 3h7l4 4v10a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z" stroke="currentColor" strokeWidth="1.4" fill="none" />
      <path d="M12 3v4h4M7 10h6M7 13h4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
    </svg>
  );
}
function ShieldSVG() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
      <path d="M10 2L3.5 4.5v6.25C3.5 14.6 6.5 17.5 10 18.5c3.5-1 6.5-3.9 6.5-7.75V4.5L10 2z" stroke="currentColor" strokeWidth="1.4" fill="none" />
...
function BarChartSVG() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" aria-hidden>
      <rect x="3" y="12" width="3" height="5" rx="0.75" fill="currentColor" opacity="0.6" />
      <rect x="8.5" y="8" width="3" height="9" rx="0.75" fill="currentColor" opacity="0.8" />
      <rect x="14" y="4" width="3" height="13" rx="0.75" fill="currentColor" />
    </svg>
  );
}
function CheckCircleSVG() {
  return (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" aria-hidden style={{ flexShrink: 0 }}>
      <circle cx="7" cy="7" r="7" fill="var(--primary-100)" />
      <path d="M4 7l2.5 2.5 4-4.5" stroke="var(--primary-600)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
const FEATURES = [
  { Icon: PackageSVG, title: 'Track', desc: 'Know exactly what you own, where it is, and who has it. QR codes on every asset, scannable from any phone.' },
  { Icon: UsersSVG,  title: 'Manage', desc: 'Assign, retire, and request changes through a structured workflow. Admin approvals built-in — no email threads.' },
  { Icon: WrenchSVG, title: 'Maintain', desc: 'Log maintenance history and warranty coverage. Get alerted before warranties lapse, not after.' },
  { Icon: FileSVG,   title: 'Comply', desc: 'Every action logged. Export audit trails for SOC 2, ISO 27001, or your internal compliance team.' },
  { Icon: ShieldSVG, title: 'Control', desc: 'Role-based access keeps the right data in the right hands. Multi-tenant by design.' },
  { Icon: BarChartSVG, title: 'Report', desc: 'Inventory metrics, maintenance costs, warranty health. Charts that tell you what to do next.' },
];
