      ...
      render: (r) => (
        <div className="flex gap-1">
          ...
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              router.push(`/super-admin/organizations/${r.organization.id}/subscription`);
            }}
            title="Subscription"
          >
          ...
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              router.push(`/super-admin/organizations/${r.organization.id}/edit`);
            }}
            title="Edit"
          >
  ...
  return (
    <div>
      <PageHeader
        title="Organizations"
        actions={
          <Button size="sm" onClick={() => router.push('/super-admin/organizations/new')}>
