...
const TIERS = [
  ...
  },
  {
    ...
    features: ['Everything in Starter', 'Approval workflows + requests', 'Maintenance records', 'Audit logs (1 year)', 'API access + webhooks'],
    featured: true,
    cta: 'Start free trial',
  },
  {
    ...
    features: ['Everything in Business', 'Audit logs (forever)', 'Custom roles & permissions', 'SLA + dedicated CSM', 'On-prem deployment option'],
    featured: false,
    cta: 'Contact sales',
  },
];
