...
export default function InventoryItemDetailPage() {
  ...
  return (
    <div>
      <PageHeader
        title={item.name}
        breadcrumb={[{ label: 'Inventory', href: `/${locale}/${orgSlug}/${space}/raseed` }, { label: item.name, href: `/${locale}/${orgSlug}/${space}/raseed/${itemId}` }]}
        actions={(
...
/** Inventory Move button — hidden when only one accessible space exists. */
