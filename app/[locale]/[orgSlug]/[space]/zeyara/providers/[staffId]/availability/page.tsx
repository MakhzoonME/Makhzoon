...
// Provider working-hours editor — Zeyara's equivalent of Haraka's
// staff/[staffId]/availability page. Same reasoning as the sibling detail
// page: the Haraka original hard-codes 'pos' / 'haraka' inline, so this is a
// small adapted copy scoped to zeyara's feature key and route root.
...
export default function ZeyaraProviderAvailabilityPage() {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 pt-2 border-t border-border">
          ...
          <div className="flex items-end">
            <Button
              ...
              className="w-full"
              style={{ background: 'var(--mod-zeyara)' }}
            >
