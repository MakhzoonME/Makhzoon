    ...
    <div>
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Customize the invoice generated from orders.</p>
        </div>
        ...
        <div className="flex-1 min-w-0 space-y-5">
          ...
          <div className="pb-4">
            <p className="text-xs text-gray-400">
              Logo, org name, address, phone, tax number, and accent color are shared with receipt settings —{' '}
