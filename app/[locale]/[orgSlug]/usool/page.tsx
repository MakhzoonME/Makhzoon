      ...
      render: (a) => (
        <div className="flex items-center gap-1">
          {isAdmin ? (
            ...
            <Button size="sm" variant="ghost" onClick={(e) => { e.stopPropagation(); router.push(`/${locale}/${orgSlug}/usool/${a.id}`); }}>{t('assets.view')}</Button>
          )}
        </div>
      )
    },
    ...
    <div>
      ...
      <div className="bg-surface-card rounded-lg border border-border">
        <DataTable
          ...
          onRowClick={(a) => router.push(`/${locale}/${orgSlug}/usool/${a.id}`)}
          keyExtractor={(a) => a.id}
