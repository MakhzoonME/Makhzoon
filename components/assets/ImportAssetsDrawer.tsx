...
/* Fuzzy-match CSV header to app field */
...
function StepBar({ step, t }: { step: Step; t: (k: Parameters<ReturnType<typeof import('@/hooks/ui').useT>['t']>[0]) => string }) {
  ...
  function parseFile(file: File) {
    ...
    Papa.parse<Row>(file, {
      ...
      complete: (res) => {
        ...
        // Build initial mapping with fuzzy matching
      ...
      <div className="space-y-5">
        ...
        {step === 'upload' && (
          <>
            ...
            {/* Drop zone */}
            <label
              className={`flex flex-col items-center justify-center gap-3 border-2 border-dashed rounded-xl p-10 cursor-pointer transition-colors duration-150
        ...
        {step === 'done' && result && (
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-end gap-2 pt-1">
              ...
              <Button size="sm" onClick={() => handleClose(false)} className="cursor-pointer transition-colors duration-150">
                {t('import.done')}
              </Button>
            </div>
          </div>
