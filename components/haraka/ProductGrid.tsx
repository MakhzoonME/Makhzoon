            ...
            {items.map((item) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  onClick={() => onPick(item)}
                  className="text-start rounded-lg border border-border bg-surface-page hover:border-primary-600 hover:bg-primary-50 transition-colors p-3 flex flex-col gap-1 min-h-[88px]"
                >
