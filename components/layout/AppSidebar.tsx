...
import { LayoutDashboard, Package, ShieldCheck, ClipboardList, Users, CreditCard } from 'lucide-react';
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? 'bg-blue-50 text-blue-700 font-medium border-l-2 border-blue-600 rounded-l-none -ml-3 pl-[calc(0.75rem+2px)]'
