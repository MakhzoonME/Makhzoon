...
import { ORG_NAV_ENTRIES, NavGroupConfig, withLocale } from '@/lib/nav';
      ...
      {mobileMenuOpen && (
        <>
          ...
          <motion.aside
            ...
            className="fixed start-0 top-0 bottom-0 z-50 w-72 bg-surface-card border-e border-border flex flex-col shadow-xl md:hidden"
          >
            <div className="flex items-center justify-between px-4 py-3 border-b border-border">
              <div className="flex items-center gap-2">
                <MakhzoonMark size={24} />
                <span className="text-[14px] font-semibold text-gray-900">Makhzoon</span>
              </div>
              <button
                type="button"
                onClick={() => setMobileMenuOpen(false)}
            ...
            {user && (
              <div className="px-4 py-3 border-b border-border">
                <div className="flex items-center gap-2">
                  <div className="h-8 w-8 rounded-full bg-primary-100 flex items-center justify-center text-[13px] font-semibold text-primary-700 flex-shrink-0">
            ...
            <nav className="flex-1 overflow-y-auto p-2.5 space-y-0.5">
              {visibleEntries.map((entry) => {
                ...
                void featureKey; void adminOnly;
            ...
            <div className="p-3 border-t border-border">
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-[13.5px] text-red-600 hover:bg-red-50 transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <LogOutSVG />
