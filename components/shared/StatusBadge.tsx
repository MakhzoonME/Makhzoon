...
const statusConfig: Record<string, { variant: 'default' | 'green' | 'yellow' | 'red' | 'blue' | 'orange'; label: string }> = {
  ...
  'Expires Today':      { variant: 'red',    label: 'Expires Today' },
  'Expires This Week':  { variant: 'orange', label: 'Expires This Week' },
  'Expires Next Week':  { variant: 'yellow', label: 'Expires Next Week' },
  'Expires This Month': { variant: 'yellow', label: 'Expires This Month' },
  'Expires Next Month': { variant: 'blue',   label: 'Expires Next Month' },
