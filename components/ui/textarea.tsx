...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, error, ...props }, ref) => (
    <textarea
      className={cn(
        'flex min-h-[64px] w-full rounded-md border bg-surface-card px-3 py-2 text-[14px] text-gray-900 dark:text-gray-700 shadow-xs',
        'transition-colors placeholder:text-gray-400 dark:placeholder:text-gray-600 leading-[1.6]',
