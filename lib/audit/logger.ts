...
export type AuditAction =
  ...
  | 'SUBSCRIPTION_UPDATED' | 'SUBSCRIPTION_AUTO_EXPIRED' | 'SUBSCRIPTION_READ_ONLY'
  ...
  | 'SUBSCRIPTION_UPGRADED' | 'SUBSCRIPTION_DOWNGRADE_SCHEDULED' | 'SUBSCRIPTION_DOWNGRADE_APPLIED'
  | 'INVOICE_GENERATED' | 'INVOICE_PAID' | 'INVOICE_REFUNDED' | 'INVOICE_VOIDED'
  ...
  | 'SERVICE_JOB_DOCUMENT_CONFIG_UPDATED'
  | 'APPOINTMENT_DOCUMENT_CONFIG_UPDATED'
  | 'REPORT_DOCUMENT_CONFIG_UPDATED'
  ...
  | 'SERVICE_JOB_AGENTS_ASSIGNED' | 'SERVICE_JOB_VEHICLE_LINKED' | 'SERVICE_JOB_RATED'
  ...
  | 'STAFF_AVAILABILITY_ADDED' | 'STAFF_AVAILABILITY_REMOVED'
  | 'STAFF_AVAILABILITY_EXCEPTION_SET' | 'STAFF_AVAILABILITY_EXCEPTION_REMOVED'
  ...
  | 'APPOINTMENT_PRODUCT_ADDED' | 'APPOINTMENT_PRODUCT_REMOVED'
  ...
  | 'APPOINTMENT_REMINDER_CONFIG_UPDATED';
