...
export const warrantyConfigSchema = z.object({
  ...
  qrSource:            z.enum(['none', 'link']).optional(),
  qrCaption:           z.string().max(60).optional(),
  qrPositionA4:        z.enum(['top-left', 'top-right', 'bottom-left', 'bottom-right']).optional(),
  qrPositionThermal:   z.enum(['top', 'bottom']).optional(),
