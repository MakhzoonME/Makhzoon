...
export type ModuleGroup = 'usool' | 'raseed' | 'haraka' | 'reports' | 'platform' | 'settings';
...
export const MODULE_GROUP_ORDER: ModuleGroup[] = ['usool', 'raseed', 'haraka', 'reports', 'platform', 'settings'];
